...
<div class="employee-form-container">
    ...
    <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group" id="specialty-group" style="display: {{ old('position', $employee->position) == 'Enseignant' ? 'block' : 'none' }};">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                @if($employee->photo)
                    <img src="{{ asset('uploads/photos/'.$employee->photo) }}" alt="Photo" width="80" style="margin-top:5px;">
                @endif
            </div>
            <div class="form-group">
                <label>CV</label>
                ...
                @if($employee->cv)
                    <a href="{{ asset('uploads/cv/'.$employee->cv) }}" target="_blank">Voir CV actuel</a>
                @endif
            </div>
        </div>
